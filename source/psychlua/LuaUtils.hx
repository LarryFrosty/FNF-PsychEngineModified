...
class LuaUtils
{
	...
	public static function getModSetting(saveTag:String, ?modName:String = null)
	{
		...
		else
		{
			...
			Debugger.instance.print('getModSetting: $path could not be found!', FlxColor.RED);
			#else
		...
		#if (LUA_ALLOWED || HSCRIPT_ALLOWED)
		Debugger.instance.print('getModSetting: "$saveTag" could not be found inside $modName\'s settings!', FlxColor.RED);
		#else
