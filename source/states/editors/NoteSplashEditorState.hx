...
class NoteSplashEditorHelpSubState extends MusicBeatSubstate
{
	public function new()
	{
		...
		var str:Array<String> = controls.mobileC ? ["Touch on a Strum", "to spawn a Splash", "", "Arrow Keys - Move Offset",
			"Hold Z - Move Offsets 10x faster", "", "C - Copy Current Offset", "V - Paste Copied Offset on Current Splash", "", "", "On every 4 subsequent note datas", "an extra set of animations will be added"] : [
